...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='处方目录';

-- ----------------------------
-- Records of rx_catalogue
-- ----------------------------
INSERT INTO `rx_catalogue` VALUES ('2', null, '1', '解表剂', null);
INSERT INTO `rx_catalogue` VALUES ('3', null, '1', '辛温解表', null);
