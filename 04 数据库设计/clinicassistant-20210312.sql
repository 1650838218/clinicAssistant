...
INSERT INTO `pur_order` VALUES ('28', '210102630', '2021-01-02', '3', '10.0000', null, '\0', '2021-01-02 20:57:08', '2021-01-02 20:57:08');
INSERT INTO `pur_order` VALUES ('29', '210102226', '2021-01-02', '3', '12.0000', null, '\0', '2021-01-02 20:57:41', '2021-01-02 20:57:41');
INSERT INTO `pur_order` VALUES ('30', '210102433', '2021-01-02', '3', '12.0000', null, '\0', '2021-01-02 21:03:26', '2021-01-02 21:03:26');
...
-- ----------------------------
-- Table structure for rx_daily
-- ----------------------------
DROP TABLE IF EXISTS `rx_daily`;
CREATE TABLE `rx_daily` (
  `rx_daily_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `register_number` varchar(10) DEFAULT NULL COMMENT '就诊号',
  `arrive_time` datetime DEFAULT NULL COMMENT '就诊时间',
  `patient_name` varchar(10) DEFAULT NULL COMMENT '患者姓名',
  `patient_sex` tinyint(1) unsigned DEFAULT NULL COMMENT '患者性别',
  `patient_age` varchar(5) DEFAULT NULL COMMENT '年龄',
  `age_unit` varchar(1) DEFAULT NULL COMMENT '年龄单位',
  `patient_phone` varchar(15) DEFAULT NULL COMMENT '电话',
  `patient_job` varchar(20) DEFAULT NULL COMMENT '职业',
  `patient_address` varchar(50) DEFAULT NULL COMMENT '住址',
  `self_speak` varchar(500) DEFAULT NULL COMMENT '主诉',
...
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8 COMMENT='处方笺';

-- ----------------------------
-- Records of rx_daily
-- ----------------------------
INSERT INTO `rx_daily` VALUES ('18', '1', '2021-02-06 16:23:00', '和三', '1', '13', null, '15613365655', null, null, null, null, null, null, null, null, null, '2021-01-24 19:24:37', null, null, null, null, null, '0', null);
INSERT INTO `rx_daily` VALUES ('19', '2', '2021-02-06 18:23:00', '和珅', '1', '34', null, '15613320588', null, '周楼', null, null, null, null, null, null, null, '2021-01-24 21:45:42', null, null, null, null, null, '0', null);
INSERT INTO `rx_daily` VALUES ('20', '3', '2021-02-06 16:12:00', '111', '1', '26', null, '', null, '', null, null, null, null, null, null, null, '2021-01-24 21:45:54', null, null, null, null, null, '0', null);
INSERT INTO `rx_daily` VALUES ('24', '1', '2021-03-03 16:38:23', '孙悟空', '1', '12', null, '15623453444', null, '哒哒哒', null, null, null, null, null, null, null, '2021-03-03 16:38:23', null, null, null, null, null, '0', null);

-- ----------------------------
-- Table structure for rx_daily_herbal
-- ----------------------------
DROP TABLE IF EXISTS `rx_daily_herbal`;
CREATE TABLE `rx_daily_herbal` (
  `rx_daily_herbal_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '虚拟主键',
  `rx_daily_id` bigint(20) unsigned NOT NULL COMMENT '处方笺ID',
  `dose_count` int(2) unsigned DEFAULT NULL COMMENT '剂数',
  `single_money` decimal(12,2) unsigned DEFAULT NULL COMMENT '单剂金额',
  `usage_dose` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '用法用量',
  `total_money` decimal(12,2) unsigned DEFAULT NULL COMMENT '总金额',
  `advice` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '医嘱',
  PRIMARY KEY (`rx_daily_herbal_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='中草药处方';

-- ----------------------------
-- Records of rx_daily_herbal
-- ----------------------------

-- ----------------------------
-- Table structure for rx_daily_herbal_dtl
-- ----------------------------
DROP TABLE IF EXISTS `rx_daily_herbal_dtl`;
CREATE TABLE `rx_daily_herbal_dtl` (
  `rx_daily_herbal_dtl_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '虚拟主键',
  `rx_daily_id` bigint(20) unsigned NOT NULL COMMENT '处方笺ID',
  `item_id` bigint(20) unsigned DEFAULT NULL COMMENT '品目ID',
  `dose` decimal(12,2) DEFAULT NULL COMMENT '剂量',
  `unit_price` decimal(12,2) DEFAULT NULL COMMENT '单价',
  `total_money` decimal(12,2) DEFAULT NULL COMMENT '金额',
  PRIMARY KEY (`rx_daily_herbal_dtl_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='中草药方明细';

-- ----------------------------
-- Records of rx_daily_herbal_dtl
-- ----------------------------

-- ----------------------------
-- Table structure for rx_daily_patent
-- ----------------------------
DROP TABLE IF EXISTS `rx_daily_patent`;
CREATE TABLE `rx_daily_patent` (
  `rx_daily_patent_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '虚拟主键',
  `rx_daily_id` bigint(20) NOT NULL COMMENT '处方笺ID',
  `total_money` decimal(12,2) DEFAULT NULL COMMENT '总金额',
  `advice` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '医嘱',
  PRIMARY KEY (`rx_daily_patent_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='中成药处方';

-- ----------------------------
-- Records of rx_daily_patent
-- ----------------------------

-- ----------------------------
-- Table structure for rx_daily_patent_dtl
-- ----------------------------
DROP TABLE IF EXISTS `rx_daily_patent_dtl`;
CREATE TABLE `rx_daily_patent_dtl` (
  `rx_daily_patent_dtl_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '虚拟主键',
  `rx_daily_id` bigint(20) unsigned NOT NULL COMMENT '处方笺ID',
  `item_id` bigint(20) unsigned DEFAULT NULL COMMENT '品目ID',
  `dose` decimal(12,2) DEFAULT NULL COMMENT '数量',
  `usage_dose` varchar(50) DEFAULT NULL COMMENT '用法用量',
  `unit_price` decimal(12,2) DEFAULT NULL COMMENT '单价',
  `total_money` decimal(12,2) DEFAULT NULL COMMENT '金额',
  PRIMARY KEY (`rx_daily_patent_dtl_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='中成药方明细';

-- ----------------------------
-- Records of rx_daily_patent_dtl
-- ----------------------------

-- ----------------------------
-- Table structure for rx_daily_skill
-- ----------------------------
DROP TABLE IF EXISTS `rx_daily_skill`;
CREATE TABLE `rx_daily_skill` (
  `rx_daily_id_skill_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '虚拟主键',
  `rx_daily_id` bigint(20) NOT NULL,
  `dose_count` int(2) unsigned DEFAULT NULL COMMENT '治疗次数',
  `single_money` decimal(12,2) unsigned DEFAULT NULL COMMENT '单次金额',
  `total_money` decimal(12,2) unsigned DEFAULT NULL COMMENT '总金额',
  `advice` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '医嘱',
  PRIMARY KEY (`rx_daily_id_skill_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='医技处方';

-- ----------------------------
-- Records of rx_daily_skill
-- ----------------------------

-- ----------------------------
-- Table structure for rx_daily_skill_dtl
-- ----------------------------
DROP TABLE IF EXISTS `rx_daily_skill_dtl`;
CREATE TABLE `rx_daily_skill_dtl` (
  `rx_daily_skill_dtl_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '虚拟主键',
  `rx_daily_id` bigint(20) unsigned NOT NULL COMMENT '处方笺ID',
  `item_id` bigint(20) unsigned DEFAULT NULL COMMENT '品目ID',
  `dose` decimal(12,2) unsigned DEFAULT NULL COMMENT '次数',
  `unit_price` decimal(12,2) unsigned DEFAULT NULL COMMENT '单价',
  `total_money` decimal(12,2) unsigned DEFAULT NULL COMMENT '金额',
  PRIMARY KEY (`rx_daily_skill_dtl_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='医技处方明细';

-- ----------------------------
-- Records of rx_daily_skill_dtl
-- ----------------------------
