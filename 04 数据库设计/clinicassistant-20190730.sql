...
INSERT INTO `pharmacy_item` VALUES (1,'三七',1,_binary '\0','','SQ','sanqi','','','','','','',500.00,1),(2,'当归',1,_binary '\0','','DG','danggui','','','','','','',500.00,1),(3,'白术',1,_binary '\0','','BZ','baizhu','','','','','','',500.00,1);
...
INSERT INTO `purchase_order` VALUES (2,'190730949','2019-07-30',1,1,1000.00,NULL,_binary '\0','2019-07-30 13:32:51','2019-07-30 13:32:51');
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='采购单明细';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `purchase_order_detail` VALUES (1,2,1,NULL,'1','2019-07-01','2019-07-31',5.00,1,200.00,1000.00);
...
CREATE TABLE `unit_conversion` (
  `source_unit` varchar(500) NOT NULL COMMENT '源单位(字典键：SLDW)',
  `target_unit` varchar(500) NOT NULL COMMENT '目标单位(字典键：SLDW)',
  `conversion_value` double(12,2) DEFAULT NULL COMMENT '换算值',
  PRIMARY KEY (`source_unit`,`target_unit`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='单位换算表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `unit_conversion` VALUES ('1','1',1000.00);
...
-- Dump completed on 2019-07-30 14:40:33
