...
CREATE TABLE `item_acupoint` (
  ...
  PRIMARY KEY (`item_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='腧穴表';
...
CREATE TABLE `item_consumable` (
  ...
  PRIMARY KEY (`item_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='其他耗材表';

-- ----------------------------
-- Records of item_consumable
-- ----------------------------
INSERT INTO `item_consumable` VALUES ('1', '方便袋', null, null, '50只/包', '河北');
INSERT INTO `item_consumable` VALUES ('2', '处方笺', null, null, '100页/本', '山东');
...
INSERT INTO `item_medical_supply` VALUES ('7', '酒精苗期23', null, null, null, 'sss', 'ssss', '', '', '22', '2.000000');
...
CREATE TABLE `item_skill` (
  ...
  PRIMARY KEY (`item_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='医疗项目表';
