...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='病历';
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='病历处方';
...
CREATE TABLE `medical_record_rx_detail` (
  ...
  `stock_detail_id` bigint(20) DEFAULT NULL COMMENT '药品ID，库存明细ID',
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='病历处方明细';
