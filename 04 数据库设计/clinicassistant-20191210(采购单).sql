...
CREATE TABLE `pur_order` (
  ...
  `total_price` double(14,4) unsigned DEFAULT NULL COMMENT '采购单金额',
...
CREATE TABLE `pur_order_detail` (
  ...
  `pur_count` double(14,4) unsigned DEFAULT NULL COMMENT '数量',
  `unit_price` double(14,4) unsigned DEFAULT NULL COMMENT '进价',
  `total_price` double(14,4) unsigned DEFAULT NULL COMMENT '总价',
