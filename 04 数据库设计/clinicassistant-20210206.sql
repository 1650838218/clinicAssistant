...
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8 COMMENT='处方笺';
...
-- ----------------------------
-- Table structure for `rx_daily_herbal_med`
-- ----------------------------
DROP TABLE IF EXISTS `rx_daily_herbal_med`;
CREATE TABLE `rx_daily_herbal_med` (
  `rx_daily_herbal_med_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `rx_daily_id` bigint(20) unsigned NOT NULL COMMENT '处方笺ID',
  `dose_count` int(2) unsigned DEFAULT NULL COMMENT '剂数',
  `single_money` decimal(12,2) unsigned DEFAULT NULL COMMENT '单剂金额',
  `usage_dose` varchar(100) COLLATE utf8_bin DEFAULT NULL COMMENT '用法用量',
  `total_money` decimal(12,2) unsigned DEFAULT NULL COMMENT '总金额',
  `advice` varchar(100) COLLATE utf8_bin DEFAULT NULL COMMENT '医嘱',
  PRIMARY KEY (`rx_daily_herbal_med_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

-- ----------------------------
-- Records of rx_daily_herbal_med
-- ----------------------------

-- ----------------------------
-- Table structure for `rx_daily_patent_med`
-- ----------------------------
DROP TABLE IF EXISTS `rx_daily_patent_med`;
CREATE TABLE `rx_daily_patent_med` (
  `rx_daily_patent_med_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `rx_daily_id` bigint(20) NOT NULL COMMENT '处方笺ID',
  `usage_dose` varchar(100) COLLATE utf8_bin DEFAULT NULL COMMENT '用法用量',
  `total_money` decimal(12,2) DEFAULT NULL COMMENT '总金额',
  `advice` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`rx_daily_patent_med_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

-- ----------------------------
-- Records of rx_daily_patent_med
-- ----------------------------
...
CREATE TABLE `rx_daily_skill` (
  `rx_daily_skill_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键ID',
