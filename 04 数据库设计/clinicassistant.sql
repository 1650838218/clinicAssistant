...
CREATE TABLE `pharmacy_item` (
  `pharmacy_item_id` int(10) NOT NULL COMMENT '主键ID',
...
CREATE TABLE `purchase_order` (
  `purchase_order_id` int(10) NOT NULL COMMENT '主键ID',
  ...
  KEY `FK_Reference_1` (`supplier_id`),
  CONSTRAINT `FK_Reference_1` FOREIGN KEY (`supplier_id`) REFERENCES `supplier` (`supplier_id`)
...
CREATE TABLE `purchase_order_detail` (
  `purchase_order_detail_id` int(10) NOT NULL COMMENT '主键ID',
  `purchase_order_id` int(10) DEFAULT NULL COMMENT '采购单ID',
  `pharmacy_item_id` int(10) DEFAULT NULL COMMENT '品目ID',
  ...
  KEY `FK_Reference_2` (`pharmacy_item_id`),
  KEY `FK_Reference_7` (`purchase_order_id`),
  CONSTRAINT `FK_Reference_7` FOREIGN KEY (`purchase_order_id`) REFERENCES `purchase_order` (`purchase_order_id`),
  CONSTRAINT `FK_Reference_2` FOREIGN KEY (`pharmacy_item_id`) REFERENCES `pharmacy_item` (`pharmacy_item_id`)
...
CREATE TABLE `supplier` (
  `supplier_id` int(10) NOT NULL COMMENT '主键ID',
  `supplier_name` varchar(50) NOT NULL COMMENT '供应商名称',
  `supplier_phone` varchar(15) NOT NULL COMMENT '供应商电话',
  `main_products` varchar(500) DEFAULT NULL COMMENT '主营',
  `supplier_address` varchar(500) DEFAULT NULL COMMENT '供应商地址',
...
-- Records of supplier
-- ----------------------------
INSERT INTO `supplier` VALUES ('191', '李同仁', '15613305758', '中草药', '北京同仁堂');
INSERT INTO `supplier` VALUES ('192', '周俊晓', '15615785622', '中草药', '临西周楼');
INSERT INTO `supplier` VALUES ('194', '神威大药房', '15613305288', '中成药', '河北石家庄');
...
CREATE TABLE `warehousing_entry` (
  `warehousing_entry_id` int(10) NOT NULL COMMENT '主键ID',
  `purchase_order_id` int(10) DEFAULT NULL COMMENT '采购单ID',
  ...
  KEY `FK_Reference_8` (`purchase_order_id`),
  CONSTRAINT `FK_Reference_8` FOREIGN KEY (`purchase_order_id`) REFERENCES `purchase_order` (`purchase_order_id`)
...
CREATE TABLE `warehousing_entry_detail` (
  `warehousing_entry_detail_id` int(10) NOT NULL COMMENT '主键ID',
  `warehousing_entry_id` int(10) DEFAULT NULL COMMENT '入库单ID',
  `purchase_order_detail_id` int(10) DEFAULT NULL COMMENT '采购单明细ID',
  ...
  KEY `FK_Reference_5` (`warehousing_entry_id`),
  KEY `FK_Reference_6` (`purchase_order_detail_id`),
  CONSTRAINT `FK_Reference_6` FOREIGN KEY (`purchase_order_detail_id`) REFERENCES `purchase_order_detail` (`purchase_order_detail_id`),
  CONSTRAINT `FK_Reference_5` FOREIGN KEY (`warehousing_entry_id`) REFERENCES `warehousing_entry` (`warehousing_entry_id`)
